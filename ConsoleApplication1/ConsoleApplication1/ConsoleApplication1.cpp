...
void output_multip(double** matrix) {
...
int main()
{
	...
	else if (method == 3)																						// Начало операции умножения
	{
		...
		cout << "Матрица B:" << endl;
		output_multip(matrix2);																						// Вывод массива ввиде таблицы

		cout << "Полученна матрица C:" << "C=A+B" << endl;
		double** matrix3 = getMatrix(column_y, string_n);														// Инициализация новой массива matrix3
